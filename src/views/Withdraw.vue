<template>
  <div class="mh-75 is-flex is-align-items-center is-justify-content-center">
    <div class="container">
      ...
      <div class="columns m-0">
        <div class="column">
          <p class="title heading is-4 has-text-centered" style = "margin: 0px !important">
            Group Withdraw
          </p>
          <p class = "has-text-centered" style = "margin: 1.5rem"><small>
            Instantly paid but must be within group for 3-7 days prior to withdrawal.
          </small></p>
          <WithdrawForm />
        </div>
        <div class="column">
          ...
          <p class = "has-text-centered" style = "margin: 1.5rem"><small>
            Instantly paid but then will pend for 3-7 days.
          </small></p>
